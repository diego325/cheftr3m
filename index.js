...
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:🇫🇷𝐂𝐇𝐄𝐅 𝐓𝐑𝟑𝐌᭄\n' // Seu nome
            + 'ORG:𝐂𝐇𝐄𝐅 𝐓𝐑𝐄𝐌 𝐁𝐎𝐓𝐙𝐈𝐍;\n' // Nome do bot
            + 'TEL;type=CELL;type=VOICE;waid=5521997854480:+55 21 99785-4480\n' //Seu número Whatsapp
            + 'END:VCARD'
...
𝐀𝐯𝐢𝐬𝐨 𝐩𝐚𝐫𝐚 𝐯𝐨𝐜𝐞 𝐪𝐮𝐞 𝐬𝐚𝐢𝐮 @${num.split('@')[0]} 𝐁𝐨𝐢 𝐛𝐨𝐢 𝐛𝐨𝐢,𝐛𝐨𝐢 𝐝𝐚 𝐜𝐚𝐫𝐚 𝐩𝐫𝐞𝐭𝐚 𝐪𝐮𝐞𝐦 𝐬𝐚𝐢𝐮 𝐝𝐨 𝐠𝐫𝐮𝐩𝐨 𝐦𝐚𝐦𝐚 𝐚 𝐩𝐢𝐤𝐚 𝐝𝐨 𝐜𝐚𝐩𝐞𝐭𝐚😂👋`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: 'CALMO FILHAO VOU FAZER',
				success: '✔️ PRONTIN CRIA ✔️',
				error: {
					stick: '❌ MANDA A IMAGEM COM A LEGENDA (stick) DENOVO PQ DEU ERRO AQUI',
					Iv: '❌ link invalido cria ❌'
				},
				only: {
					group: '❌ Este comando só pode ser usado em grupos! ❌',
					premium: '[❗] ESTE PEDIDO É SO PARA *USUÁRIOS PREMIUMS*',
					ownerG: '❌ Este comando só pode ser usado pelo CHEF! ❌',
					ownerB: '❌ Este comando só pode ser usado pelo meu CHEF! ❌',
            ...
            const premium = ["5521997854480@s.whatsapp.net","${setting.vip2}@s.whatsapp.net","${setting.vip3}@s.whatsapp.net","${setting.vip4}@s.whatsapp.net","${setting.vip5}@s.whatsapp.net","${setting.vip6}@s.whatsapp.net","${setting.vip7}@s.whatsapp.net","${setting.vip8}@s.whatsapp.net","${setting.vip9}@s.whatsapp.net","${setting.vip10}@s.whatsapp.net",]
...
client.sendMessage('5521997854480@s.whatsapp.net', options, text, {quoted: mek})
...
case 'antifake':
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* CHEF TR3M\n*WPP:* wa.me/+5521997854480\n*INSTA:* @Chef_tr3m\n\n\nEspero que tenham gostado do botzin 🥵'})
					  client.sendMessage(from, 'Ctt do meu dono ai Wa.me/5521997854480 , pfv n flode',MessageType.text, { quoted: mek} )
                    break
				...
				case 'clearall':
					...
					break
				case 'bc':
					if (!isOwner) return reply('Quem e tu caraio kksks?')
      ...
      if (!isGroup) return reply(mess.only.group)
				...
				case 'banir':
					...
					if (mentioned.length > 1) {
						teks = 'putinha removido com sucesso :\n'
